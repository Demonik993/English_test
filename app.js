...
function calculateAnswers(answers, questions) {
  ...
  // SUMMARY TO SEND
  checkedAnswers.summary = `Student gave ${correctAnswers} correct answers, ${wrongAnswers} wrong and didn't answer on ${noAnswers}. The student result is ${
    result * 100
  }% correct answer.;`;
...
function nextQuestion(questionNumber, questions) {
  //adding progress bar
  const width =
    Math.round((questionNumber / Object.keys(questions).length) * 100) / 100;
